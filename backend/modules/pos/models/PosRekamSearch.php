 ...
 */
class PosRekamSearch extends PosRekam {
...
//        $query = PosMaster::find()->where(['bidang_id' => Yii::$app->user->identity->unit_id, 'status_srt' => ['1']]);
        $query = PosMaster::find()->where([ 'status_srt' => ['1']]);
        // add conditions that should always apply here

        $dataProvider = new ActiveDataProvider([
            'query' => $query,
            'sort'=> ['defaultOrder' => ['status_srt'=>SORT_ASC]]
        ]);
