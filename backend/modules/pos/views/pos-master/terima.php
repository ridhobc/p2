...
$this->title = 'Penerimaan Permintaan Pengeposan Surat Keluar';
                        ...
                        [
                            ...
                            'value' => function ($data) {
                                ...
                                [
                                    ...
                                    'header' => 'Terima',
                                    'value' => function ($data) {
                                        return Html::a("<i class='fa fa-forward'></i>", ['proterima', 'id' => $data->id], ['class' => 'btn btn-danger', 'title' => 'kirim ke Bagian Umum']); // ubah ini
                                    },
                                        ],
