...
$this->title = 'Pickup Surat Oleh Petugas POS';
...
<div class="box box-default">
    <div class="box-header with-border ">
        <p>
            ...
            <?= Html::a('<i class="fa fa-print "></i> Cetak', ['/pos/pos-master/cetak-tanda-terima'], ['class' => 'btn btn-warning']) ?>    
...
//                                ],
                        ...
                        [
                            ...
                            'value' => function ($data) {
                                ...
                                return Html::a("<i class='fa fa-forward'></i>", ['propickup', 'id' => $data->id], ['class' => 'btn btn-danger','title' => 'Pick Up']); // ubah ini
                            },
                                ],
