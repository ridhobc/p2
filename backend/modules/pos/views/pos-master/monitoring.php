...
$this->title = 'Monitoring Pengiriman Pos Surat Keluar';
...
//                                ],
                        ...
                        'header' => 'View',
                        'value' => function ($data) {
                            if($data->status_srt=='1' || $data->status_srt=='2' || $data->status_srt=='3' || $data->status_srt=='4'){
                                return Html::a("<i class='fa fa-eye'></i>", ['view-kirim', 'id' => $data->id], ['class' => 'btn btn-success', 'title' => 'View']); // ubah ini
                            } else if($data->status_srt=='5' || $data->status_srt='6') {
                            return Html::a("<i class='fa fa-eye'></i>", ['view-kirim-detail', 'id' => $data->id], ['class' => 'btn btn-success', 'title' => 'View']); // ubah ini
                            }
                        },
                            ],
