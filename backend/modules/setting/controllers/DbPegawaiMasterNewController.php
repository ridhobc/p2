...
use backend\modules\setting\models\DbPegawaiMasterNew;
use backend\modules\setting\models\DbPegawaiMasterNewSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DbPegawaiMasterNewController implements the CRUD actions for DbPegawaiMasterNew model.
 */
class DbPegawaiMasterNewController extends Controller
{
    /**
     * @inheritDoc
     */
