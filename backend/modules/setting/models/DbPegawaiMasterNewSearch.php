...
/**
 * DbPegawaiMasterNewSearch represents the model behind the search form of `backend\modules\setting\models\DbPegawaiMasterNew`.
 */
class DbPegawaiMasterNewSearch extends DbPegawaiMasterNew
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'tgl_pangkat_berikutnya' => $this->tgl_pangkat_berikutnya,
        ]);
