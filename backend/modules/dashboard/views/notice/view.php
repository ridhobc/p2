...
?>
<div class="col-xs-12">
  <div class="col-lg-4 col-sm-4 col-xs-12 no-padding"><h3 class="box-title"><i class="fa fa-search"></i> <?php echo Yii::t('dash', 'View Notice') ?></h3></div>
  ...
  <div class="box box-primary view-item">
   <div class="notice-view">
	...
	'options'=>['class'=>'table  detail-view'],
        ...
        'value' => ($model->updated_by == null) ? " - ": $model->updatedBy->username,
	    ],
        ],
    ]) ?>
   </div>
