...
<div class="col-xs-6 col-lg-6">
  <div class="<?php echo $model->isNewRecord ? 'box-success' : 'box-info'; ?> box view-item col-xs-12 col-lg-12">
   <div class="notice-form">
    ...
    <?= $form->field($model, 'notice_title')->textInput(['maxlength' => 100, 'placeholder' => Yii::t('dash', 'Enter Title'), 'title' => 'Title']) ?>
    ...
    <?= $form->field($model, 'notice_user_type')
                        ->radioList( ['0' => Yii::t('dash', 'Notice'),"1" => Yii::t('dash', 'Info'),],
    ...
    <?= $form->field($model, 'notice_date')->widget(yii\jui\DatePicker::className(),
       ...
       <?= $form->field($model, 'notice_date_end')->widget(yii\jui\DatePicker::className(),
                    [
                      'clientOptions' => [
                          'dateFormat' => 'dd-mm-yyyy',
                          'changeMonth' => true,
