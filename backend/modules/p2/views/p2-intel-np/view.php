...
?>
<?php
$cekno1 = \backend\modules\p2\models\P2IntelNpNosurat::find()
        ->where(['np_id' => $model->id])
        ->count();
?>
<h3 class="box-title">
    ...
    if ($cekno1 > '0') {
        ...
        echo Html::a('Ambil Nomor', ['ambil-no-np', 'id' => $model->id], ['class' => 'btn btn-danger']);
    }
    ?>
    <i class="fa fa-file "></i>  <?php echo Yii::t('app', 'NP'); ?></h3>         
<div  role="main">
    <div class="">
